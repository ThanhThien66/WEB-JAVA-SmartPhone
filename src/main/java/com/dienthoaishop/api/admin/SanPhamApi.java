...
import com.dienthoaishop.dto.SanPhamDto;
...
import com.dienthoaishop.validator.SanPhamDtoValidator;
...
public class SanPhamApi {
	...
	public Page<SanPham> getAllSanPhamByFilter(@RequestParam(defaultValue = "1") int page,
			@RequestParam String danhMucId, @RequestParam String hangSXId, @RequestParam String donGia,
			@RequestParam String sapXepTheoGia) {
