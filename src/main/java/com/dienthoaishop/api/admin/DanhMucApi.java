...
public class DanhMucApi {
	...
	public ResponseObject addDanhMuc(@RequestBody @Valid DanhMuc newDanhMuc, BindingResult result,
	...
	public ResponseObject updateDanhMuc(@RequestBody @Valid DanhMuc editDanhMuc, BindingResult result,
			HttpServletRequest request) {
