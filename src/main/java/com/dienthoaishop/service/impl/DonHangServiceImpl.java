...
import com.dienthoaishop.dto.SearchDonHangObject;
import com.dienthoaishop.entities.DonHang;
import com.dienthoaishop.entities.NguoiDung;
import com.dienthoaishop.entities.QDonHang;
import com.dienthoaishop.repository.DonHangRepository;
...
public class DonHangServiceImpl implements DonHangService {
	...
	@Override
	public List<DonHang> findByName(String hoTenNguoiNhan) {
		return donHangRepo.findByhoTenNguoiNhan(hoTenNguoiNhan);
	}

	@Override
	public List<DonHang> findByhoTenNguoiNhan() {
		return donHangRepo.findAllByhoTenNguoiNhan();
	}
