				...
				<div class="wrapper row">
					<div class="preview col-md-6">
						...
						<div class="preview-pic tab-content">
							<div class="tab-pane active" id="pic-1">
								<img src="/dienthoaishop/img/${sp.getId()}.png" />
							</div>
						</div>
					</div>
					<div class="details col-md-6">
						...
						<c:if test="${sp.getHeDieuHanh().length() > 0}">
							<p class="product-description">Hệ điều hành:
								${sp.getHeDieuHanh()}</p>
						</c:if>
						...
						<c:if test="${sp.getDungLuongPin().length() > 0}">
							<p class="product-description">Dung lượng pin:
						...
						<h4 class="price">
							Giá bán: <span>${sp.getDonGia()} VND</span>
						</h4>
						<div class="action">
							<button class="add-to-cart btn btn-default" type="button"
								onclick='window.alert("Đã thêm sản phẩm vào giỏ hàng");'>Giỏ
								hàng</button>
						</div>
					</div>
				</div>
